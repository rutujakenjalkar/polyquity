...
# 2. Wrap THIS function as the tool
prospectus_tool = Tool(
    name="ipo_prospectus_expert",
    func=get_prospectus_answer,
    description="Ask this tool for specific facts, dates, or risks from the IPO Prospectus. It provides full-sentence, professional answers."
)
